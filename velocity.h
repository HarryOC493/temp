...
// L_Thigh
float L_Thigh[7] = {2.54, 0.49, 90, -90, A0, 0, 0}; // Added 2 elements for prevPosition and prevTime
// R_Thigh
float R_Thigh[7] = {2.41, 0.24, 90, -90, A3, 0, 0};
...
// L_Ankle
float L_Ankle[7] = {1.51, 0.66, 25, -40, A4, 0, 0};
// R_Ankle
float R_Ankle[7] = {2, 1.28, 45, -30, A5, 0, 0};
